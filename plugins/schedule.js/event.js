$(function () {
    ...
    $.ajax({
        ...
        success: function (rsp) {
            ...
            rspShiftSchedule.forEach((schedule) => {
                ...
                var scheduleDate = moment(schedule.scheduleDate).format(
                    "YYYY-MM-DD"
                );
                var myEvent = {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventClick: function (dataxxx) {
            ...
            $("#oldId").val(
                staffId + oldName + oldDate + oldTime + oldLeaveType
            );
    ...
    function deleteData() {
        var oldEventId = document.getElementById("oldId").value;
        var relax = oldEventId.substring(
            oldEventId.length - 1,
            oldEventId.length
        ); //取最後一個值
        // console.log(oldid);
