...
window.onload = function () {
  ...
  $("button.search").on("click", function () {
    ...
    $.ajax({
      url: "http://35.236.152.197/yokult/api/0.01/order/selectOrderid", // 資料請求的網址
  ...
  $("button.searchStatus").on("click", function () {
    ...
    $.ajax({
      url: "http://35.236.152.197/yokult/api/0.01/order/selectOrderStatus", // 資料請求的網址
      type: "POST", // GET | POST | PUT | DELETE | PATCH
      contentType: "application/json",
      data: JSON.stringify({
...
function init() {
  ...
  $.ajax({
    url: "http://35.236.152.197/yokult/api/0.01/order/", // 資料請求的網址
...
function getOrderlist(ordId) {
  ...
  let url = new URL("http://35.236.152.197/yokult/api/0.01/orderlist/");
  if (ordId !== null && ordId !== "") {
...
function saveProduct() {
  ...
  fetch("http://35.236.152.197/yokult/api/0.01/orderlist/", requestOptions)
    .then((response) => response.text())
    .then((result) => search())
    .catch((error) => console.log("error", error));
